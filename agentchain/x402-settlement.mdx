...
flowchart TD
    ...
    style H fill:#0a0a0b,stroke:#10B981,stroke-width:2px,color:#fafafa
    style I fill:#0a0a0b,stroke:#fbbf24,stroke-width:2px,color:#fafafa
...
```bash
curl https://api.agentchain.cloud/api/v1/settlement/actions \
...
```bash
curl https://api.agentchain.cloud/api/v1/settlement/stats \
  -H "Authorization: Bearer $JWT"
```
