...
The circuit auto-recovers after 60 seconds of no failures (HALF_OPEN → CLOSED).
...
of a meaningful collision on a _specific target contract_ is negligible for standard EVM deployments.
